function init() {
  ...
  // Populate the dropdown with subject ID's from the list of sample Names
    ...
    // Use subject ID 
    const first_Subject = subject_IDs[0];
    updateCharts(first_Subject);
    updateMetadata(first_Subject);
  });
}
...
//create function to update the charts
function updateCharts(sample) {    
  ...
  // create variable trace to make Bubble Chart
  var trace1 = {
      x: otu_ids,
      y: sample_values,
      text: otu_labels,
  ...
  //create variable trace to make Bar Chart
  var trace1 = {
